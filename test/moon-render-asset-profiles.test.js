...
describe("moon-render-asset-profiles", () => {
    ...
    it("merges global render setting overrides", () => {
        ...
        expect(settings.fast.physicalShadowFillScale).toBe(0);
        expect(settings.quality.physicalShadowFillScale).toBe(1);
        expect(settings.low.physicalShadowFillScale).toBe(0);
