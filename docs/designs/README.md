...
Designs explain runtime structure, responsibilities, data/execution flow, and
accepted tradeoffs. Required behavior belongs in specifications; delivery work
belongs in plans.

## System And Runtime

- [Runtime System Overview](runtime/system-overview.md)
- [Runtime Target Architecture](runtime/target-architecture.md)
- [Documentation Architecture](documentation-architecture.md)
- [Repository Boundary Design](data/repository-boundary.md)
- [Runtime Experience Model](runtime-experience-model.md)

## Modes And Frames

- [Relative Frame](frames/relative-mode.md)
- [Orbit Comparison](modes/orbit-comparison.md)
...
- [Relative Mode](../specs/modes/relative-mode.md)
- [Orbit Comparison](../specs/modes/orbit-comparison.md)
- [Chebyshev Ephemeris Format](../specs/data/chebyshev-ephemeris-format.md)

## Related Plans

- [Repository Roadmap](../plans/roadmap.md)
...
- [Artemis Real-Time Experience](../plans/breakdown/artemis-real-time-experience.md)
...
- [Testing Guide](../operations/contributor/testing.md)
